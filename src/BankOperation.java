...
public class BankOperation {
    ...
    private double amount; //кол-во переводимых денег

    private long fromId;  // от кого поступили деньги

    private long toId; // кому поступили деньги

    private OperationType type;  // тип операции (используем enum)
